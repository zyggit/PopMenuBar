#
# Be sure to run `pod lib lint PopMenuBar.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'PopMenuBar'
  s.version          = '0.1.0'
  s.summary          = 'A short description of PopMenuBar.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'PopMenuBar/Classes/**/*'
  
  # s.resource_bundles = {
  #   'PopMenuBar' => ['PopMenuBar/Assets/*.png']
  # }
